...
ClothCraft uses [Creem](https://creem.io) for payment processing, supporting recurring subscriptions and existing credit pack infrastructure.
...
| Plan | Price | Credits |
|------|-------|---------|
| ClothCraft Monthly | $29/mo | Paid AI try-on access |
| ClothCraft Yearly | $290/yr | Annual subscription infrastructure |
